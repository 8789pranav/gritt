...
class ReportService:
    ...
    _TAG_SENTENCE_MAP: Dict[str, str] = {
        ...
        # Spelling — one entry per tag in data/tags/spelling_tags.json.
        # A tag with no entry here falls back to its internal description,
        # which is written for us, not for a parent.
        ...
        "vowel_emerging": "Child is still working out which vowel sound a word needs.",
        "digraph_competent": "Child spells letter pairs like sh, ch and th correctly.",
        "blend_competent": "Child spells consonant clusters like st, nd and str correctly.",
        "digraph_emerging": "Child is still learning letter pairs like sh, ch and th.",
        "blend_emerging": "Child is still learning consonant clusters like st, nd and str.",
        "sight_word_recognition_strong": "Child reliably recognises high-frequency sight words.",
        "sight_word_emerging": "Child finds common everyday words harder than words they can sound out.",
        ...
        # Speaking - one entry per tag in data/tags/speaking_tags.json.
        "decoding_accurate": "Child reads the words on the page accurately.",
        "decoding_emerging": "Child is still working out some of the words while reading aloud.",
        "decoding_developing": "Child works most words out, and a few still come out differently.",
        "reading_pace_in_band": "Child reads aloud at the pace that is usual for their year.",
        "reading_pace_above_band": "Child reads aloud a little quicker than is usual for their year.",
        "reading_pace_below_band": "Child reads aloud more slowly than is usual for their year.",
        "phrasing_smooth": "Child reads in smooth phrases rather than word by word.",
        "phrasing_choppy": "Child pauses often mid-sentence rather than reading in phrases.",
        "phrasing_developing": "Child reads in phrases some of the time and word by word at other times.",
        "expression_present": "Child reads with expression and natural rhythm.",
        "expression_flat": "Child reads in a fairly flat voice, without much expression.",
        "expression_developing": "Child’s voice rises and falls in some places and stays level in others.",
        "reads_every_word": "Child reads the whole sentence without skipping words.",
        "skips_words": "Child skips over some words while reading aloud.",
        "hesitates_before_starting": "Child takes a moment to gather themselves before reading aloud.",
        "stretches_words": "Child holds some sounds while working a word out, a normal decoding strategy.",
        "filler_habit_emerging": "Child uses filler sounds like “um” fairly often while reading.",
        "self_corrects_while_reading": "Child goes back and repeats words to get them right.",
        "vowel_sounds_secure": "Child produces short and long vowel sounds clearly when reading aloud.",
        "short_vowel_emerging": "Short vowel sounds are still settling in the child’s reading.",
        "long_vowel_emerging": "Long vowel sounds are still settling in the child’s reading.",
        "vowel_sounds_developing": "Some vowel sounds come out clearly when reading aloud and some are still settling.",
        "blends_secure": "Child says consonant clusters like st and br clearly.",
        "blends_emerging": "Consonant clusters like st and br are still tricky when reading aloud.",
        "blends_developing": "Consonant clusters like st and br come out clearly most of the time, not every time.",
        "digraphs_secure": "Child says letter pairs like sh, ch and th clearly.",
        "digraphs_emerging": "Letter pairs like sh, ch and th are still tricky when reading aloud.",
        "digraphs_developing": "Letter pairs like sh, ch and th come out clearly most of the time, not every time.",
        "ending_sounds_emerging": "Child sometimes drops the sound at the end of a word.",
        "recording_needs_review": "Some recordings could not be assessed reliably and were left out.",
        # Comprehension
